...
class LocationHelper {
  ...
  Future<LocationData> determinePosition() async {
    ...
    final result = await Geolocator.getCurrentPosition(forceAndroidLocationManager: true);
    final addressList = await placemarkFromCoordinates(result.latitude, result.longitude);
